...
public class SuperSlidingPaneLayout extends ViewGroup {
    ...
    public SuperSlidingPaneLayout(Context context) {
        this(context, null);
    }

    public SuperSlidingPaneLayout(Context context, AttributeSet attrs) {
    ...
    interface SlidingPanelLayoutImpl {
        void invalidateChildRegion(SuperSlidingPaneLayout parent, View child);
    }

    static class SlidingPanelLayoutImplBase implements SlidingPanelLayoutImpl {
        public void invalidateChildRegion(SuperSlidingPaneLayout parent, View child) {
    ...
    class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
            ...
            info.setClassName(SuperSlidingPaneLayout.class.getName());
            info.setSource(host);
        ...
        public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            event.setClassName(SuperSlidingPaneLayout.class.getName());
        }
    ...
    private class DisableLayerRunnable implements Runnable {
        ...
        @Override
        public void run() {
            if (mChildView.getParent() == SuperSlidingPaneLayout.this) {
